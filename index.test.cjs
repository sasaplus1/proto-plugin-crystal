...
describe('locate_executables', () => {
  it('should return correct executable paths for linux', async () => {
    const result = await callExtism('locate_executables', {
      context: {
        env: {
          os: 'linux'
        }
  ...
  it('should return correct executable paths for macos', async () => {
    const result = await callExtism('locate_executables', {
      context: {
        env: {
          os: 'macos'
  ...
  it('should return correct executable paths for windows', async () => {
    const result = await callExtism('locate_executables', {
      context: {
        env: {
          os: 'windows'
